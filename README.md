...
- Pour poser une question, commenter, faire un retour d’usage ou contribuer à l’amélioration du modèle de données, vous pouvez adresser un message à [contact@transport.beta.gouv.fr](mailto:contact@transport.beta.gouv.fr) ou ouvrir un ticket publique sur le [dépôt GitHub](https://github.com/etalab/schema-irve/issues) du schéma.
